...
def load_detector():
    return hub.load("https://tfhub.dev/google/faster_rcnn/openimages_v4/inception_resnet_v2/1")


st.title("🔎 Multi-Object Detector")
st.caption(
    "Upload a photo and detect 600+ everyday objects using a pre-trained "
    "Faster R-CNN model (TensorFlow Hub, Open Images V4)."
)
